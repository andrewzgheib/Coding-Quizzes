...
import com.example.codingquizzes.data.model.Answers
import com.example.codingquizzes.data.model.CorrectAnswers
import com.example.codingquizzes.data.model.QuestionWithAnswer

class ReviewAnswerAdapter: ListAdapter<QuestionWithAnswer, ReviewAnswerAdapter.QuestionViewHolder>(
    QuestionWithAnswerDiffCallback()
) {
