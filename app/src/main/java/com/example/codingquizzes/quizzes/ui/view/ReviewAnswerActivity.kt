...
import com.example.codingquizzes.quizzes.ui.adapter.ReviewAnswerAdapter
...
class ReviewAnswerActivity : AppCompatActivity() {
    ...
    private fun setupViewModel() {
        ...
        userAnswerViewModel = ViewModelProvider.AndroidViewModelFactory(application).create(UserAnswerViewModel::class.java)
